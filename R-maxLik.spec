...
Version  : 1.4.8
Release  : 39
URL      : https://cran.r-project.org/src/contrib/maxLik_1.4-8.tar.gz
Source0  : https://cran.r-project.org/src/contrib/maxLik_1.4-8.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616511495
...
/usr/lib64/R/library/maxLik/tests/maxControl_privateTest.Rout.save
/usr/lib64/R/library/maxLik/tests/maxSG_privateTest.Rout.save
